<script setup>
    ...
    const emit = defineEmits(['ocultarModal','guardarGasto','update:nombre','update:cantidad','update:categoria','eliminar-gasto'])
    ...
    // cantidad anteriormente gastada
    ...
    <div class="modal">
        ...
        >
            ...
            >
                ...
                <legend>{{ props.id ? 'Editar Gato'  : 'Añadir gasto' }}</legend>
                <!-- Nombre -->
                <div class="campo">
